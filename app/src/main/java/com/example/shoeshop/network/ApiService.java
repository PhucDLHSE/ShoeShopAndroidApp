...
// import com.example.shoeshop.models.NewProductsResponse; // Dòng này không còn cần thiết
...
public interface ApiService {
    ...
    // Endpoint để lấy danh sách sản phẩm mới
    @GET("Product/recently-added")
    Call<ProductResponse> getRecentlyAddedProducts(@Query("lastCheckedTime") String lastCheckedTime); // Thay đổi kiểu trả về
